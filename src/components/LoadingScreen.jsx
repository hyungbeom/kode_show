...
/**
 * 미니멀 랜딩 — 흰 배경, `/logo.svg` 마스크로 네이비 로고, LOADING 점 / ENTER (룸)
 * 맵 첫 랜딩은 App에서 에셋·마무리 타이머 후 자동 `onEnter` 호출.
 */
  ...
  return (
    <div className="loading-screen initial-loading loading-screen--curtain">
      <div className="loading-screen__inner">
        ...
        {mapEntryReady ? (
          <button type="button" className="loading-screen__enter" onClick={() => onEnter?.()}>
            ENTER
          </button>
        ) : (
