...
export interface ProductDetailCopy {
  ...
  description: string
  specs: string[]
  /** 캐러셀·목록용 2D 이미지 (투명 PNG 권장, 배경은 UI에서 검정 처리) */
  imageUrl: string
}
...
export const PRODUCT_DETAIL_LIST: ProductDetailCopy[] = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/kode-prod-aqual/800/800',
    description:
  ...
  },
  {
    title: '제품 2',
    subtitle: '정밀 분석',
    imageUrl: 'https://picsum.photos/seed/kode-prod-2/800/800',
    description:
  ...
  },
  {
    title: '제품 3',
    subtitle: '휴대·현장형',
    imageUrl: 'https://picsum.photos/seed/kode-prod-3/800/800',
    description:
  ...
  },
  {
    title: '제품 4',
    subtitle: '통합 솔루션',
    imageUrl: 'https://picsum.photos/seed/kode-prod-4/800/800',
    description:
  ...
  },
  {
    title: '제품 5',
    subtitle: '프리미엄',
    imageUrl: 'https://picsum.photos/seed/kode-prod-5/800/800',
    description:
